...
; for each type of expression, compiler
; dispatches to a specialized code generator
...
; 'target' specifies the register in which the compiled
; code is to return the value of the expression.

; 'linkage (descriptor)' describes how the code resulting
; from the compilation of the expression should proceed
; when it has finished its execution
;
; the linkage descriptor can require that the code 
...
; - jump to a named entry point ('label')

(define (make-intruction-sequence
...
; structure for representing compiled procedures
